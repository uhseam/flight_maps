    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='flight_maps_app.place')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='flight_maps_app.place')),
                ('depart_day', models.ManyToManyField(related_name='flights_of_the_day', to='flight_maps_app.week')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='flight_maps_app.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='flight_maps_app.passenger')),
