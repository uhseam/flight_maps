...
class Booking:
    ...
    def construct_booking(self):
        ...
        for f in self.flight['flightOffers'][0]['itineraries']:
            ...
            if len(self.flight['flightOffers'][0]['itineraries'][index]['segments']) == 2:# pragma: no cover  # one stop flight
...
def get_stoptime(total_duration, first_flight_duration, second_flight_duration):# pragma: no cover
